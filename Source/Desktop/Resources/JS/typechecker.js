...
class TypeChecker
{
  ...
  {
    if(!this.check({ type: 'array', value: types })) 
    {
      console.error(this.#errors.checkMultipleTypeError);
      return false;
    }
  ...
  * @param {Multiple} constructor - The class constructor to reference when doing the comparisons. */ 
  ...
  { 
    if(typeof name !== "string" || !(constructor instanceof Function)) 
    {
      console.error(this.#errors.registrationOfNewTypeError);
      return;
    }
